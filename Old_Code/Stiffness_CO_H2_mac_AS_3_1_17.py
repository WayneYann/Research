...
# Instead of using 2 axes for particles and time, just use one with all the
# same data in order to compute things much faster
#numevals = len(pasr[0,:,0]) * len(pasr[:,0,0])
...
#pyl.xlabel('Particle')
#pyl.ylabel('Timestep')
#plot = pyl.contourf(xmesh,ymesh,np.log(pasrstiffnesses2[:,:100,14]),50)
#pyl.grid(b=True, which='both')
#pyl.colorbar(plot)
#pyl.savefig('Particle_Timestep_0.jpg')
